                    ...
                    <table id="tabla-lecturas" class="table table-striped dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">{{ number_format($lectura->total_global ?? 0) }}</td>
                                <td class="text-end">{{ number_format($lectura->total_bn ?? 0) }}</td>
                                <td class="text-end">{{ number_format($lectura->total_color ?? 0) }}</td>
